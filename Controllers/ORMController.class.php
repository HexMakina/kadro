...
abstract class ORMController extends KadroController implements Interfaces\ORMController
{
  ...
  public function before_edit()
  {
    ...
    {
      $this->logger()->warning('KADRO_CRUDITES_ERR_INSTANCE_NOT_FOUND', ['MODEL_'.$this->model_class_name::model_type().'_INSTANCE']);
  ...
  public function destroy_confirm()
  {
    ...
    {
      $this->logger()->warning('KADRO_CRUDITES_ERR_INSTANCE_NOT_FOUND', ['MODEL_'.$this->model_type.'_INSTANCE']);
  ...
  public function before_destroy() // default: checks for load_model and immortality, hops back to object on failure
  {
    ...
    elseif($this->load_model->immortal())
    {
      ...
      $this->logger()->warning('KADRO_CRUDITES_ERR_INSTANCE_IS_IMMORTAL', ['MODEL_'.$this->model_type.'_INSTANCE']);
  ...
  public function destroy()
  {
    ...
    {
      $this->logger()->info('KADRO_CRUDITES_ERR_INSTANCE_IS_UNDELETABLE', [''.$this->load_model]);
      $this->route_back($this->load_model);
    }
    else
    {
      $this->logger()->nice('KADRO_CRUDITES_INSTANCE_DESTROYED', ['MODEL_'.$this->model_type.'_INSTANCE']);
