...
require_once 'StorageManager/FileManager.class.php';


use \HexMakina\kadro\hopper;

class PictureManagerException extends \Exception
{
...
**/
class PictureManager extends FileManager
{
